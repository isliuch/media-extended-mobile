...
- Android 可选安装独立的 Media Extended 截图助手 APK。“辅助 APK 一键截图”按钮使用系统 MediaProjection 授权抓取当前屏幕，自动裁剪播放器、识别当前视频时间并插入此前聚焦的笔记。1.0.3 起可选启用无障碍服务：首张截图没有可读时间时，助手会自动点击视频使控制条显示，再用第二张截图识别时间。原相机按钮和图片导入按钮均保留。
