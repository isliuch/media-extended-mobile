...
const sourceFrameFallbackSetting =
...
if (!bundle.includes(sourceFrameFallbackSetting)) {
  failures.push("Android source-frame fallback setting is missing from main.js");
}
